...
- [Together AI](guides/together.md)
...
- Cross-Provider Support: Consistent implementation across OpenAI, Together, Vercel, xAI, Anthropic, and Google.
...
Currently, tool calling is supported for the OpenAI, Together, Vercel, xAI, Anthropic, and Google providers. Support for other providers will be added in future updates.
